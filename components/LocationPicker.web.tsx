...
export function LocationPicker({
  ...
  const center = useMemo(
    ...
    [initialCenter.latitude, initialCenter.longitude, value?.latitude, value?.longitude],
  );
  ...
  useEffect(() => {
    ...
    async function initMap() {
      ...
      if (markerRef.current) {
        ...
        markerRef.current = leaflet.circleMarker([center.latitude, center.longitude], {
          radius: 10,
  ...
  return (
    <View style={styles.container}>
      ...
      {value ? (
        ...
        <Text style={styles.helper}>Search for a place or tap the map to set the game location.</Text>
      )}
