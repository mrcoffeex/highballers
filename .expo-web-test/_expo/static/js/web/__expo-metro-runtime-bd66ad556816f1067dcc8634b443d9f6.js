...
!(function (e) {
  ...
  function u(e, o) {
    ...
    const u = i(e, o);
    let d;
    if (u && u.__esModule) d = u;
    else {
      if (((d = {}), u)) for (const e in u) n.call(u, e) && (d[e] = u[e]);
      d.default = u;
    }
    return (t.get(e).importedAll = d);
  }
  ((i.importDefault = l),
    ...
    if (
      ...
      ((console.reportErrorsAsExceptions = !0),
        (console.error = function (...e) {
          if ((h.apply(this, e), !console.reportErrorsAsExceptions)) return;
          ...
          if (r?.stack) t = r;
            ...
            const n = e.map((n) => ("string" == typeof n ? n : y(n))).join(" ");
